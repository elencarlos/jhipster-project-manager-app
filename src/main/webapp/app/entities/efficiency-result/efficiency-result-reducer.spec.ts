...
import reducer, { getEntities, getEntity, reset } from './efficiency-result.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EFFICIENCYRESULT_LIST actions', async () => {
    ...
    it('dispatches FETCH_EFFICIENCYRESULT actions', async () => {
      const expectedActions = [
        {
